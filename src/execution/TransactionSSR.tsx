        ...
        <div className="py-6 max-w-7xl mx-auto">
          ...
          {tx && (
            <>
              ...
              <TransactionActionLite logs={tx.logs} value={tx.value} from={tx.from} to={tx.to} data={tx.data} authorizationList={tx.authorizationList} resolvedAction={tx.resolvedAction} />
