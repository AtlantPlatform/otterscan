    ...
    <div className="min-h-screen overflow-x-hidden">
      <StandardFrame>
        <Helmet>
          ...
          <meta name="description" content="Browse the latest Ethereum blocks with detailed information about gas usage, base fees, and block times. Real-time blockchain data." />
